...
import { simulationService, FlightData, DashboardStats } from './src/simulationService.ts'
import { DroneVisualization } from './src/DroneVisualization.tsx'
    ...
    <div className="App">
      ...
      <main>
        <section className="drone-visualization-container">
          <DroneVisualization isSimulating={isSimulating} />
        </section>
